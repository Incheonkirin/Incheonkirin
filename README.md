...
- **[apache/lucene #16242](https://github.com/apache/lucene/pull/16242)** — new `HangulCompositionCharFilter` for analysis-nori: NFD-form Hangul was silently unanalyzable as Korean ([#16241](https://github.com/apache/lucene/issues/16241)); approved by Robert Muir / Lucene PMC. *(open)*
...
**Also (Korean & search infra)** — Korean tokenizer offsets (spaCy #13974), Elasticsearch wildcard-normalizer escaping (#151008), FAISS musllinux wheels restored (#5272). Reported issue: NAVER hcx-vllm-plugin #5 (`<|im_end|>` parser boundary). [Full PR list →](https://github.com/search?q=author%3AIncheonkirin+type%3Apr&type=pullrequests)
